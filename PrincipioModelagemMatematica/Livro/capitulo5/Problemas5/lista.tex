...
\begin{titlepage}
    \begin{center}
        ...
        \LARGE\textbf{Principles of Mathematical Modeling (2nd Edition):\\
            Solução dos Problemas 5.1 a 5.48}\\[3cm]
...
\foreach \i in {1,...,48} {
    ...
    \section*{Problema 5.\i}

    % Enunciado
    \IfFileExists{enunciado/e\i.tex}{
        \enunciado{\input{enunciado/e\i.tex}}
    }{
        \textbf{Enunciado não encontrado para o Problema 5.\i}
    }
    ...
    \IfFileExists{respostas/r\i.tex}{
        ...
        \textbf{Resposta não encontrada para o Problema 5.\i}
    }
