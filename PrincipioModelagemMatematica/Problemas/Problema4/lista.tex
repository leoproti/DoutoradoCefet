...
\begin{titlepage}
    \begin{center}
        ...
        \LARGE\textbf{Principles of Mathematical Modeling (2nd Edition):\\
            Solução dos Problemas 4.1 a 4.55}\\[3cm]
...
\foreach \i in {1,...,55} {
    ...
    \IfFileExists{resposta/r\i.tex}{
        ...
        \textbf{Resposta não encontrada para o Problema 4.\i}
    }
